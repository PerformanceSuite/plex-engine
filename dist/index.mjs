...
import { useRef as useRef2, useEffect as useEffect2, useState as useState3, useCallback as useCallback3 } from "react";
...
function useNodeMeasures(containerRef) {
  const [rects, setRects] = useState2(/* @__PURE__ */ new Map());
  const frameRef = useRef(0);
  const remeasure = useCallback2(
    (nodeIds) => {
...
var PlexBreadcrumb = ({
  ...
  return /* @__PURE__ */ jsx3(
    "nav",
    {
      ...
      children: trail.map((node, i) => /* @__PURE__ */ jsxs3(React2.Fragment, { children: [
        i > 0 && /* @__PURE__ */ jsx3("span", { style: { opacity: 0.4 }, children: "/" }),
        /* @__PURE__ */ jsx3(
          "button",
          {
...
function usePlexState(initialActiveId) {
  const [activeId, setActiveId] = useState4(initialActiveId);
  const navigate = useCallback4((nodeId) => {
    setActiveId(nodeId);
  }, []);
